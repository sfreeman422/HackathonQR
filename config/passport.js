...
module.exports = (passport) => {
  ...
  // This entire thing is a strategy AKA a method that passport can use to authenticate.
  // This will specifically use a mongo database to do this.
  ...
  passport.use('local-login', new LocalStrategy(
    ...
    ((req, email, password, done) => {
      User.findOne({ 'local.email': email }, (err, user) => {
        ...
        if (!user.validPassword(password)) { return done(null, false, console.log('PW is wrong.')); }
